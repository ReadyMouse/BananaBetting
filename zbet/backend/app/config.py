...
class Settings:
    ...
    ORACLE_ZCASH_ADDRESS: str = os.getenv("ORACLE_ZCASH_ADDRESS", "ztestsapling1oracle123456789abcdefghijklmnopqrstuvwxyz")
    ...
    @classmethod
    def get_oracle_address(cls) -> str:
        return cls.ORACLE_ZCASH_ADDRESS
    ...
    def get_config_summary(cls) -> dict:
        ...
        return {
            ...
            "oracle_address": cls.ORACLE_ZCASH_ADDRESS[:20] + "..." if len(cls.ORACLE_ZCASH_ADDRESS) > 20 else cls.ORACLE_ZCASH_ADDRESS,
        }
